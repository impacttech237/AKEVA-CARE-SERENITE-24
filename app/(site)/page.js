...
import { getSite, getServices, getArticles, getFaqs, getSteps, getTestimonials } from "@/lib/data";
...
export default async function HomePage() {
  const [site, services, articles, faqs, steps, testimonials] = await Promise.all([
    getSite(),
    getServices(),
    getArticles(),
    getFaqs(),
            ...
            <div>
              ...
              <div className="btn-row mt-m">
                <a
                  ...
                  href={whatsappLink(site.whatsapp, "Bonjour Akeva Care, je souhaite parler à un conseiller.")}
                  target="_blank"
          ...
          <Reveal className="photo-cta">
            ...
            <span className="txt">
              ...
              <div className="btn-row mt-m">
                ...
                <a className="btn btn-light" href={whatsappLink(site.whatsapp)} target="_blank" rel="noopener noreferrer">
                  WhatsApp
                </a>
              </div>
            </span>
